...
router.get('/settings/deleteStudent/:id', requireAuth, controller.getStudentDelete);
router.post('/settings/deleteStudent', requireAuth, controller.postStudentDelete);
//3.6 Activate existing students
router.get('/settings/activateStudent/:id', requireAuth, controller.getStudentActivate);
router.post('/settings/activateStudent', requireAuth, controller.postStudentActivate);
